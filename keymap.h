...
// from https://github.com/Globidev/ClipboardOne/blob/master/ClipboardOne/Core/KeyLogger.h
// By Guillaume Depardon
// Awesome, ty <3 !
...
{
    typedef QMap<DWORD, int> KeyMap;
    typedef QMap<int, QString> KeyStringMap;
